...
STAGE_SCHEMAS: Dict[str, StageSchema] = {
    ...
    "synthesis": StageSchema(
        ...
        fields=(
            ...
            FieldSpec(name="semantic_gates", required=False, expected_type="list"),
            FieldSpec(name="semantic_nodes", required=False, expected_type="list"),
        ),
    ),
    "synthesis_patch": StageSchema(
        name="synthesis_patch",
        fields=(
            FieldSpec(name="components", required=False, expected_type="list"),
            FieldSpec(name="relationships", required=False, expected_type="list"),
            FieldSpec(name="constraints", required=False, expected_type="list"),
            FieldSpec(name="unresolved", required=False, expected_type="list"),
            FieldSpec(name="semantic_gates", required=False, expected_type="list"),
    ...
    "verification": StageSchema(
        ...
        fields=(
            ...
            FieldSpec(name="completeness", required=False, expected_type="any"),
            FieldSpec(name="consistency", required=False, expected_type="any"),
            FieldSpec(name="coherence", required=False, expected_type="any"),
            FieldSpec(name="traceability", required=False, expected_type="any"),
            FieldSpec(name="subsystem_validation", required=False, expected_type="any"),
            FieldSpec(name="overall_insight", required=False, expected_type="str"),
            FieldSpec(name="recommendation", required=False, expected_type="str"),
            FieldSpec(name="semantic_gates", required=False, expected_type="list"),
        ),
    ),
}
