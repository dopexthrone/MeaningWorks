...
const NAV_ITEMS = [
  { href: '/', label: 'Compile', icon: CommandIcon },
  { href: '/corpus', label: 'Corpus', icon: ArchiveIcon },
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-56 h-screen border-r border-[var(--border)] bg-[var(--bg-secondary)]">
      ...
      <div className="px-4 py-3 border-t border-[var(--border)] text-xs text-[var(--text-muted)] flex items-center gap-2">
        <StatusDot status="ok" pulse />
        <span>Semantic IDE</span>
      </div>
    </aside>
  );
}
